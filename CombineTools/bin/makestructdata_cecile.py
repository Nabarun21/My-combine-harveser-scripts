...
for filename in os.listdir('../../../../../CMSSW_8_0_13/src/UWHiggs/lfvemu/LFVHEMuAnalyzerMVA_cecilentuple'):
   file=ROOT.TFile('../../../../../CMSSW_8_0_13/src/UWHiggs/lfvemu/LFVHEMuAnalyzerMVA_cecilentuple/'+filename)
