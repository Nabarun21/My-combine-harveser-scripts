...
for filename in os.listdir('../../../../../CMSSW_8_0_13/src/UWHiggs/lfvemu/LFVHEMuAnalyzerMVA_postBDTwithpt_depth3'):
   file=ROOT.TFile('../../../../../CMSSW_8_0_13/src/UWHiggs/lfvemu/LFVHEMuAnalyzerMVA_postBDTwithpt_depth3/'+filename)
