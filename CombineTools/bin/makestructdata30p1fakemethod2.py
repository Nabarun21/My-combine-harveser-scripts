...
lumidict2['WG']=8e-07
lumidict2['T']=3.5e-06
lumidict2['FAKES']=float(1.0)/float(36100)
...
for key in cat_then:
   histos[key]=[]
for filename in os.listdir('../../../../../CMSSW_8_0_13/src/UWHiggs/lfvemu20fb/LFVHEMuAnalyzerMVA'+sys.argv[1]+sys.argv[2]+'fakesfromdatamethod2'):
   if "QCD" in filename or "WJETS" in filename or "ETau" in filename:continue
   file=ROOT.TFile('../../../../../CMSSW_8_0_13/src/UWHiggs/lfvemu20fb/LFVHEMuAnalyzerMVA'+sys.argv[1]+sys.argv[2]+'fakesfromdatamethod2/'+filename)
...
outputfile=ROOT.TFile("../../../lfvauxiliaries/shapes/Nab2016LFV/LFV_fakes_36fb_"+sys.argv[1]+".root","recreate")
