...
lumidict['QCD']=18900.0




lumidict2['data_obs']=12900.0
lumidict2['Dibosons']=5e-06
lumidict2['TT']=8.7e-07
lumidict2['WJETSMC']=1.5e-05
lumidict2['DY']=1.1e-06
lumidict2['ggHTauTau']=2.04e-07
lumidict2['vbfHTauTau']=4.2e-09
lumidict2['LFVGG125']=1.9e-07
lumidict2['LFVVBF125']=4.8e-09
lumidict2['WG']=8e-08
lumidict2['T']=3.5e-07
lumidict2['QCD']=float(1.0)/float(18900)
...
for filename in os.listdir('../../../../../CMSSW_8_0_13/src/UWHiggs/lfvemu_20fb/LFVHEMuAnalyzerMVA_btag'):
   file=ROOT.TFile('../../../../../CMSSW_8_0_13/src/UWHiggs/lfvemu_20fb/LFVHEMuAnalyzerMVA_btag/'+filename)
   print filename
   new_title=filename.split('.')[0]
   print "newtitle",new_title
   for i in range(4):
      if cat_now[i]=='':
